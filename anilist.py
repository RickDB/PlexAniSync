...
class anilist_custom_mapping:
    def __init__(self, season, anime_id, start):
        self.season = season
...
def find_mapped_series(anilist_series, anime_id):
...
def map_watchcount_to_seasons(title, season_mappings, watched_episodes):
